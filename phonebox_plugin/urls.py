...
urlpatterns = [
    ...
    path('import_voice_circuits/', views.VoiceCircuitEditView.as_view(), name='import_voice_circuits'),
    path("voice_circuit/<int:pk>/edit/", views.NumberEditView.as_view(), name="voice_circuit_edit"),
